...
struct ENTT_API LightComponent {
    ...
    void save(Archive &archive) const {
        ...
        archive(
            ...
            cereal::make_nvp("diffuseColor", std::array{ cereal::make_nvp("r", diffuse.r), cereal::make_nvp("g", diffuse.g), cereal::make_nvp("b", diffuse.b) }), cereal::make_nvp("specularColor", std::array{ cereal::make_nvp("r", specular.r), cereal::make_nvp("g", specular.g), cereal::make_nvp("b", specular.b) }));
    }
