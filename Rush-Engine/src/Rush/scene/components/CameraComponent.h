...
struct ENTT_API CameraComponent {
    ...
    void save(Archive &archive) const {
        ...
        archive(
            ...
            cereal::make_nvp("type", std::string(camera.IsPerspective() ? "perspective" : "orthogonal")), cereal::make_nvp("frustum", std::array{ cereal::make_nvp("near", camera.GetNear()), cereal::make_nvp("far", camera.GetFar()), cereal::make_nvp("fov", camera.GetFOV()) }), cereal::make_nvp("skybox", sbp));
    }
    ...
    void load(Archive &archive) {
        ...
        archive(
            cereal::make_nvp("main", main),
            cereal::make_nvp("clear",
                             std::array{
                                 cereal::make_nvp("r", clearColor.r),
                                 cereal::make_nvp("g", clearColor.g),
                                 cereal::make_nvp("b", clearColor.b),
                                 cereal::make_nvp("a", clearColor.a) }),
            cereal::make_nvp("type", type), cereal::make_nvp("frustum", std::array{ cereal::make_nvp("near", near), cereal::make_nvp("far", far), cereal::make_nvp("fov", fov) }), cereal::make_nvp("skybox", skyboxBuf));
